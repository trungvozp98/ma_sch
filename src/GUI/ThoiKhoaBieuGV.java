 ...
 * @author trung98
 */
public class ThoiKhoaBieuGV extends javax.swing.JFrame {

    /**
     * Creates new form ThoiKhoaBieuGV
     */
    private DefaultTableModel model;
    private ArrayList<DangKyDay> listDKD;

    public ThoiKhoaBieuGV() {
        initComponents();
    ...
    public void loadThoikhoabieu() {
        txthocky.setFont(new Font(MainGV.hocky, 0, 14));
        ...
        for (DangKyDay dkd : listDKD) {
            i++;
            model.addRow(toObjectsDatatkb(dkd, i));
        }
        bangtkb.setModel(model);

    }

    public Object[] toObjectsDatatkb(DangKyDay dkd, int i) {
        ...
        Object[] objectsData = {i, lhp.getThu(), mh.getTenMH(), lhp.getMaLHP(), lhp.getTiet(), lhp.getPhonghoc()};
    ...
    private void initComponents() {
        ...
        txthocky.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        txthocky.setText("HỌC KỲ 1");

        jLabel3.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jLabel3.setText("NĂM ");

        txtnamhoc.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel9Layout.createSequentialGroup()
                ...
                .addGap(3, 3, 3)
                .addComponent(txtnamhoc, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(71, 71, 71)
        ...
        jPanel9Layout.setVerticalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txthocky, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtnamhoc, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        bangtkb.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Thứ", "Môn", "Lớp", "Tiết học", "Phòng"
            }
        ));
        ...
        bangtkb.getColumnModel().getColumn(2).setPreferredWidth(200);
        bangtkb.getColumnModel().getColumn(3).setPreferredWidth(100);
        bangtkb.getColumnModel().getColumn(4).setPreferredWidth(100);
    ...
    private void btnExportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportActionPerformed
        ...
        String hocky = MainGV.hocky.toUpperCase();

        titleCell.setCellValue("THỜI KHÓA BIỂU " + hocky + " NĂM HỌC " + MainGV.namhoc + " MAGV: " + Main.nameLogin2);
        ...
        for (int i = 0; i < bangtkb.getRowCount(); i++) {
            ...
            // Phòng
            cell = row.createCell(5, CellType.STRING);
            cell.setCellValue((String)(bangtkb.getValueAt(i, 5)));
            cell.setCellStyle(styleData);
        ...
        File file = new File("E:/Learn Java/Slide UIT/" + "TKB_" + Main.nameLogin2 + ".xlsx");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThoiKhoaBieuGV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
